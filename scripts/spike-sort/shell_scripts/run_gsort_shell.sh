...
for dataset in ${datasets[@]}; do
    ...
    outpath="/Volumes/Scratch/Users/jeffbrown/gsort-30mu-raphe/"
    mkdir -p $outpath

    wnoise=${wnoises[$ind]}
    estim=${estims[$ind]}
    
    python /Volumes/Lab/Users/jeffbrown/g-sort/scripts/spike-sort/run-gsort-standard.py -d $dataset -w $wnoise -e $estim -o $outpath -t $THREADS -i $N_SIGMAS -m "oldlv" -el 30 -cd 0 -wb 20 -eb $estim_base -vb $vstim_base 
